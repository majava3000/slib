...
#define SIM_SOPT2_RMIISRC_mask        (0x00080000U) // RMII clock source select
#define SIM_SOPT2_RMIISRC_offset      (19)
#define SIM_SOPT2_RMIISRC_width       (1)
#define SIM_SOPT2_TIMESRC_mask        (0x00300000U) // IEEE 1588 timestamp clock source select
#define SIM_SOPT2_TIMESRC_offset      (20)
...
#define SIM_SCGC1_UART5_mask   (0x00000800U) // UART5 Clock Gate Control
#define SIM_SCGC1_UART5_offset (11)
#define SIM_SCGC1_UART5_width  (1)

// SCGC2 (System Clock Gating Control Register 2)
#define SIM_SCGC2_ENET_mask   (0x00000001U) // ENET Clock Gate Control
#define SIM_SCGC2_ENET_offset (0)
